...
public class AnswerController {
    ...
    public String createAnswer(Model model, @PathVariable("id") Long id,
        ...
        AnswerEntity answerEntity = this.answerService.create(questionEntity,answerForm.getContent());
        return String.format("redirect:/question/detail/%s#answer",answerEntity.getQuestion().getId());
    }

    /* GET 방식의 답변 수정 처리 */
    @GetMapping("/modify/{id}")
    public String answerModify(AnswerDTO answerForm, @PathVariable("id") Long id) {
    ...
    public String answerModify(@Valid AnswerDTO answerForm, BindingResult bindingResult,
        ...
        /* 답변 객체 생성 */
        AnswerEntity answerEntity = this.answerService.getAnswer(id);
        this.answerService.modify(answerEntity, answerForm.getContent());
        return String.format("redirect:/question/detail/%s#answer",answerEntity.getQuestion().getId());
    }
